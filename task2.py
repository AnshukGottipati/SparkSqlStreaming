...
watermarked_df = parse_df.withWatermark("timestamp", "10 minutes")
...
def write_batch(batch_df, batch_id):
    ...
    (batch_df
        ...
        .mode("overwrite")
        .option("header", True)
        .csv(f"./outputs/task_2/batch_id={batch_id}")
    )
...
query = (
    agg_df.writeStream
    .outputMode("update")
    .option("checkpointLocation", "/tmp/ride_sharing/checkpoints/driver_metrics")
